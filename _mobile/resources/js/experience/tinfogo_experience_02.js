$(".bottomBtn").off("click").on("click", function() {
	...
	location.replace("/experience/03?selected_product_seq=" + selected_product_seq + "&selected_children=" + selected_children + "&address_json=" + encodeURIComponent(JSON.stringify(address)));
});
